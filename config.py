...
CATEGORIES = [
    ...
    },
    {
        ...
        "bar_color": "#1D9E75",
        "display_max": 5,
        # 브랜드명 정밀화: 스테이지5→스테이지파이브, 세븐모바일→SK세븐모바일,
        # U모바일→U+유모바일, KCT 제거(티플러스로 커버·약어 잡음 큼)
        "keywords": [
            "프리티 알뜰폰", "티플러스", "헬로모바일", "SK세븐모바일",
            "KT M모바일", "모빙 알뜰폰", "이야기모바일", "스테이지파이브", "U+유모바일",
        ],
        # 게임·애니·연예 오탐 제외 (이 카테고리 한정)
        "exclude": [
