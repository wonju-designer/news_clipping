...
CATEGORIES = [
    ...
    },
    {
        ...
        # 게임·애니 + LG유플러스(MNO) 제외. 단 protect_terms(유모바일)면 예외 유지
        "exclude": [
        ...
        "subgroups": [
            {
                ...
                "priority_own": ["파워넷"],
                "priority_ind": ["SMPS", "전원", "전력변환", "GaN"],
                "keywords": [
                    "파워넷 SMPS", "파워넷 전원공급장치", "파워넷 아이즈비전",
                    "파워넷 실적", "파워넷 코스닥",
                ],
                "industry_keywords": [
                    "SMPS 시장", "전원공급장치 시장", "전력변환장치", "GaN 전력반도체",
                    "데이터센터 전원장치", "AI 서버 전원", "EMS 전자제조", "배터리팩 시장",
                ],
                "exclude": ["게이밍 파워", "조립컴퓨터", "파워서플라이 추천"],
            },
            {
            ...
            },
            {
                ...
                "industry_keywords": [
                    "가정간편식 HMR 시장", "밀키트 시장", "냉동식품 수출",
                    "K-푸드 수출", "떡볶이 수출", "간편식 트렌드",
                ],
                "exclude": ["아이스크리에이티브"],
            },
            {
